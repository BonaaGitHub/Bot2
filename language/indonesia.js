exports.private = () =>{
	return`Fitur hanya bisa di gunakan di private chat deck`
	}
exports.wait = () => {
    return `⏳tunggu bentar deck~`
}
...
exports.erorLink = () => {
    return `⚠️ Link nya error Deck`
}
exports.media = () => {
    return `Pilih media yang mau lu download deck`
}
...
exports.ownerOnly = () => {
    return `❎ Command ini khusus Owner Deck`
}
...
exports.groupOnly = () => {
    return `👥  Command ini hanya bisa digunakan di dalam grup deck!`
}

exports.adminOnly = () => {
    return `🙅  Command ini hanya bisa digunakan oleh admin grup deck!`
}

exports.nhFalse = () => {
    return `Kode tidak valid! deck`
}
